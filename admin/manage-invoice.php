                ...
                while($row = mysqli_fetch_assoc($res)){
                    ...
                    <tr>
                        ...
                        <td> <!-- So what happens here is to display the "pay now" only if its not paid-->
                            <?php if($amount_paid != $amount){$siteurl = SITEURL; echo "<a href='{$siteurl}crud/pay-invoice.php?id={$invoice_id}'><button class='btn-primary pad-1'>PAY</button></a>"; }?>
