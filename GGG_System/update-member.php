...
<div class="main-content">
    <div class="header">
        <h1 class ="txt-center">Update Member</h1>
        <p>
            <?php
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    if(!empty($_FILES["image"]["name"]))
                    {
                        ...
                        if($upload == false)
                        {
                            ...
                            header('location:'.SITEURL.'update-member.php');
                            die();
                        }
                    ...
                    //if the query works redirect with success message else redirect with a fail message
                    if($res3 == true)
                    {
                    ...
                    {
                        $_SESSION['update'] = "fail to update member";
                        header('location:'.SITEURL.'update-member.php');
                    }
