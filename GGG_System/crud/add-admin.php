...
<div class="main-content">
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql = "INSERT INTO user (username, password, role, image_name, name, phone, emergency_contact, email, account_date_created) VALUES ('$username', '$password', $role, '$image_name', '$full_name', '$phone', '$emergency', '$email', NOW());";
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="tbl-wrapper">
                <table class = "tbl-30">
                    ...
                    <tr>
                        <td>Phone*</td>
                        <td><input type="number" name="phone" id="" placeholder = "#"></td>
                    </tr>
                    <tr>
                        <td>Emergency Contact</td>
                        <td><input type="number" name="emcontact" placeholder = "#" id=""></td>
                    </tr>
                    <tr>
                        <td>Email*</td>
                        <td><input type="email" name = "email" placeholder = "JohnDoe1@gmail.com"></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <br>
                            <input type="submit" value="+ Admin" name = "submit" class = "btn-primary">
                        </td>
                    </tr>
                </table>
            </div>
